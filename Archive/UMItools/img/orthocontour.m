function [fig1, fig2, fig3] =  orthocontour(h,d,x,y,z,roi)
%function [fig1, fig2, fig3] =  orthocoutour(h,d,x,y,z,roi)
%
...
if isempty(h)
    ...
    fig1=subplot (223);
    contour(squeeze(d(:,:,z))), axis ([0.5 h.ydim 0.5 h.xdim]) , axis xy %xy %,axis tight
    ...
    fig2=subplot (222);
    contour(squeeze(d(:,y,:))'), axis ([0.5 h.xdim 0.5 h.zdim]),axis  xy %, axis tight
    ...
    fig3=subplot (221);
    contour(squeeze(d(x,:,:))'), axis ([0.5 h.ydim 0.5 h.zdim]), axis xy%, axis tight
