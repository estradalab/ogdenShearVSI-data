function result = avg_fmri_skip (inroot, outroot, first, last, skip)
%
% function result = avg_fmri_skip(inroot, outroot, first, last, skip)
%
% Luis Hernandez
...
% skip	is the number of types of trials present 
% 		(i.e. - control task and real task = 2) alternating.
%
...
for j = first:last
   ...
   for i=0:reps-1
      ...
      imgname = strcat(inroot,addzeros(i*timepoints*skip + j )  );
