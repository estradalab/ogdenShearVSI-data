...
if any(strcmp(varargin,'shphase'));
    ...
    if nargin>ii && isnumeric(varargin{ii+1}) && varargin{ii+1}>=-0.5 && varargin{ii+1}<=0.5;
        ...
        if strcmp(out.pars.seqfil,'mge3d') || strcmp(out.pars.seqfil,'mge3d');
...
out.pars.axis1 = ((-si(1)/2+0.5:si(1)/2-0.5)/si(1)*out.pars.lro -out.pars.pro)*10;
out.pars.axis2 = ((-si(2)/2+0.5:si(2)/2-0.5)/si(2)*out.pars.lpe - out.pars.ppe)*10;
