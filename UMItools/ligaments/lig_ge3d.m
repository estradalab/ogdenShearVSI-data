function out=lig_ge3d(varargin)
...
data=varianms(timestamp,'gradlag',48);  %approximately (0.25mm}^3 for typical ligament acquisition
...
mask=abs(blurredpic)>5*blurrednoiselevel;
...
save(matfilename, 'axis1','axis2','axis3','compleximage','mask','noiselevel','comment','timest','position','params');
