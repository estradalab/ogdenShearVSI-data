function output = biaxial_decomp_0707_exp_biaxial2()
...
load('Data/23-0707-Biaxial2-exp/disp_data_20230707-eco_biaxial2_4.5mm_9mm.mat');
if mask_shape
    load('Data/23-0707-Biaxial2-exp/mask_data_900.mat')
    for t = 1:length(F_t)
        for i = 1:3
            for j = 1:3
...
switch calc_goodness
    case 'k_lam'
        ...
        for i = 1:length(F_t)
            ...
            if i == 1
                if mask_shape
                    saveas(gcf,['Data/23-0707-Biaxial2-exp/2Dhist_disc_k_lam_3.75.png'])
                    saveas(gcf,['Data/23-0707-Biaxial2-exp/2Dhist_disc_k_lam_3.75.pdf'])
                else
                    saveas(gcf,['Data/23-0707-Biaxial2-exp/2Dhist_fullsample_k_lam_3.75.png'])
                    saveas(gcf,['Data/23-0707-Biaxial2-exp/2Dhist_fullsample_k_lam_3.75.pdf'])
                end
            elseif i ==2
                if mask_shape
                    saveas(gcf,['Data/23-0707-Biaxial2-exp/2Dhist_disc_k_lam_8.25.png'])
                    saveas(gcf,['Data/23-0707-Biaxial2-exp/2Dhist_disc_k_lam_8.25.pdf'])
                else
                    saveas(gcf,['Data/23-0707-Biaxial2-exp/2Dhist_fullsample_k_lam_8.25.png'])
                    saveas(gcf,['Data/23-0707-Biaxial2-exp/2Dhist_fullsample_k_lam_8.25.pdf'])
                end
            end
        end
        ...
        if mask_shape
            saveas(gcf,'Data/23-0707-Biaxial2-exp/goodness_metric_k_lam_disc.png')
            saveas(gcf,'Data/23-0707-Biaxial2-exp/goodness_metric_k_lam_disc.pdf')
        else
            saveas(gcf,'Data/23-0707-Biaxial2-exp/goodness_metric_k_lam_fullsample.png')
            saveas(gcf,'Data/23-0707-Biaxial2-exp/goodness_metric_k_lam_fullsample.pdf')
        end
    ...
    case 'criscione'
        ...
        for i = 1:length(F_t)
            ...
            if i == 1
                if mask_shape
                    saveas(gcf,['Data/23-0707-Biaxial2-exp/2Dhist_disc_k2_k3_3.75.png'])
                    saveas(gcf,['Data/23-0707-Biaxial2-exp/2Dhist_disc_k2_k3_3.75.pdf'])
                else
                    saveas(gcf,['Data/23-0707-Biaxial2-exp/2Dhist_fullsample_k2_k3_3.75.png'])
                    saveas(gcf,['Data/23-0707-Biaxial2-exp/2Dhist_fullsample_k2_k3_3.75.pdf'])
                end
            elseif i ==2
                if mask_shape
                    saveas(gcf,['Data/23-0707-Biaxial2-exp/2Dhist_disc_k2_k3_8.25.png'])
                    saveas(gcf,['Data/23-0707-Biaxial2-exp/2Dhist_disc_k2_k3_8.25.pdf'])
                else
                    saveas(gcf,['Data/23-0707-Biaxial2-exp/2Dhist_fullsample_k2_k3_8.25.png'])
                    saveas(gcf,['Data/23-0707-Biaxial2-exp/2Dhist_fullsample_k2_k3_8.25.pdf'])
                end
            end
        end
        ...
        legend(output.lbl{1},output.lbl{2},'interpreter','latex')
        if mask_shape
            saveas(gcf,'Data/23-0707-Biaxial2-exp/goodness_metric_k2_k3_disc.png')
            saveas(gcf,'Data/23-0707-Biaxial2-exp/goodness_metric_k2_k3_disc.pdf')
        else
            saveas(gcf,'Data/23-0707-Biaxial2-exp/goodness_metric_k2_k3_fullsample.png')
            saveas(gcf,'Data/23-0707-Biaxial2-exp/goodness_metric_k2_k3_fullsample.pdf')
        end
end