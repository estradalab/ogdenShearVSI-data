function output = biaxial_decomp_0712_sim_9mmdisp()
...
fileName = 'Biaxial_Plus_DoubleDisp';
...
switch calc_xref
    ...
    case 0
        load('Data\23-0712-Biaxial_double-sim\refpositions.mat')
        output.X_ref = X_ref;
end
...
switch read_dat
    ...
    case 0
        load('Data\23-0712-Biaxial_double-sim\MRI-3Ddefs_Biaxial_23-0712.mat')
...
output.lbl{1} = 'Biaxial_{sim,full} (9mm)'; output.lbl{2} = 'Biaxial_{sim,disc} (9mm)';
...
switch calc_decomp
    case 1
        ...
        save('Data/23-0712-Biaxial_double-sim/sensitivity.mat','k','lam','k2','k3');
        output.k = k; output.lam = lam; output.k2 = k2; output.k3 = k3;
    case 0
        load('Data/23-0712-Biaxial_double-sim/sensitivity.mat')
        output.k = k; output.lam = lam; output.k2 = k2; output.k3 = k3;
end
...
switch calc_goodness
    case 'k_lam'
        ...
        for i = 1:length(output.k)
            ...
            if i == 1
                saveas(gcf,['Data/23-0712-Biaxial_double-sim/2Dhist_full_k_lam.png'])
                saveas(gcf,['Data/23-0712-Biaxial_double-sim/2Dhist_full_k_lam.pdf'])
            elseif i ==2
                saveas(gcf,['Data/23-0712-Biaxial_double-sim/2Dhist_disc_k_lam.png'])
                saveas(gcf,['Data/23-0712-Biaxial_double-sim/2Dhist_disc_k_lam.pdf'])
            end
        end
        ...
        saveas(gcf,'Data/23-0712-Biaxial_double-sim/goodness_metric_k_lam.png')
        saveas(gcf,'Data/23-0712-Biaxial_double-sim/goodness_metric_k_lam.pdf')
    ...
    case 'criscione'
        ...
        for i = 1:length(output.k3)
            ...
            c.Label.String = 'log(h/sum(h(:)))';
            if i == 1
                saveas(gcf,['Data/23-0712-Biaxial_double-sim/2Dhist_full_k2_k3.png'])
                saveas(gcf,['Data/23-0712-Biaxial_double-sim/2Dhist_full_k2_k3.pdf'])
            elseif i ==2
                saveas(gcf,['Data/23-0712-Biaxial_double-sim/2Dhist_disc_k2_k3.png'])
                saveas(gcf,['Data/23-0712-Biaxial_double-sim/2Dhist_disc_k2_k3.pdf'])
            end
        end
        ...
        ylabel('$S_{metric}=\sum_{i,j}\hat{hist}\left(k_i,\lambda_j,test\right)\;.*\;\hat{S}_\alpha\left(k_i,\lambda_j,\alpha\right)$',...
            'interpreter','latex')
        legend(output.lbl{1},output.lbl{2},'interpreter','latex')
        saveas(gcf,'Data/23-0712-Biaxial_double-sim/goodness_metric_k2_k3.png')
        saveas(gcf,'Data/23-0712-Biaxial_double-sim/goodness_metric_k2_k3.pdf')
end